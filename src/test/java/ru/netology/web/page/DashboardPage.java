...
public class DashboardPage {
    ...
    SelenideElement personalAccount = $("[data-test-id=dashboard]");
    SelenideElement popUpFirstCard = $$("[data-test-id=action-deposit]").get(0);
    ...
    public MoneyTransfer popUpFirstCard() {
